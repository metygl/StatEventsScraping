"""
Scraper for ASA Columbus Chapter Events.
Site: https://sites.google.com/view/cbus-asa
...
class ASAColumbusScraper(BaseScraper):
    """Scraper for ASA Columbus chapter events from Google Sites."""

    SOURCE_NAME = "ASA Columbus"
    BASE_URL = "https://sites.google.com/view/cbus-asa"

    async def scrape(self) -> List[Event]:
        """Scrape ASA Columbus event listings."""
    ...
    async def _find_event_links(self) -> List[str]:
        ...
        urls = []
        seen = set()
        links = await self.get_all_elements("a[href*='cbus-asa']")
        for link in links:
